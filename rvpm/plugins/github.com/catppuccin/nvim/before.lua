...
vim.g['vimrc#colors'] = require('catppuccin.palettes').get_palette()
vim.g['vimrc#color_bg'] =
  require('catppuccin.palettes').get_palette(vim.g.catppuccin_flavour).base
...
vim.api.nvim_create_autocmd('ColorScheme', {
  callback = function()
    if vim.g.colors_name and vim.g.colors_name:match('catppuccin') then
      vim.g['vimrc#colors'] = require('catppuccin.palettes').get_palette()
      vim.g['vimrc#color_bg'] = require('catppuccin.palettes').get_palette(
